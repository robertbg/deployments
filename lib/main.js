                ...
                case 'start':
                    {
                        ...
                        yield client.repos.createDeploymentStatus(Object.assign(Object.assign({}, repo), { deployment_id: parseInt(deploymentID, 10), state: 'in_progress', auto_inactive: false, log_url: logsURL || `https://github.com/${repo.owner}/${repo.repo}/commit/${sha}/checks`, description }));
                ...
                case 'finish':
                    {
                        ...
                        yield client.repos.createDeploymentStatus(Object.assign(Object.assign({}, repo), { deployment_id: parseInt(deploymentID, 10), state: newStatus, auto_inactive: false, description, 
